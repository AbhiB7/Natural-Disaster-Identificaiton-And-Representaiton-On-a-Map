...
#==========================all the funcitons+======================
    ...
    def prediction(self, to_be_classified):
        ...
        if self.value_inside.get() == "SVC":
            self.filename = '/Major_Project/models/text_clf.sav'
    ...
    def find_tweet(self, coords):
        ...
        #item iterator class 
        self.public_tweets = tweepy.Cursor(self.api.search_tweets, count=5,q="place:%s" % places[0].id, tweet_mode="extended", lang = "en").items(50)                            
